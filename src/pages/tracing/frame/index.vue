...
export default {
  ...
  data() {
    return {
      prefix,
      loading: true,
      frameSrc: 'https://grafana.gpg123.vip/d/BKf2sowmj/opentelemetry-collector?var-minstep=$__auto&orgId=1&from=now-6h&to=now&timezone=utc&var-datasource=bcbe8c6b-5b42-48e1-8e9d-e6e30f72084a&var-job=opentelemetry&var-metric=rate&var-receiver=$__all&var-processor=$__all&var-exporter=$__all&var-grouping=&refresh=10s',
