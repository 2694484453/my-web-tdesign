...
// 开发模式
const devRouterList = [...baseRouters, ...domainRouters, ...gitRouters, ...devopsRouters, ...monitorRouters, ...repoRouters, ...traefikRouters, ...clusterRouters, ...caddyRouters, ...corednsRouters, ...backupRouters]
// 生产模式
